...
In this section, we implement a two-level multilevel model that accounts for spatial heterogeneity effects between the levels. We firstly load price paid paid from the Land Registry:
...
# check null model to evaluate how variation in median house price decomposed to LSOA and MSOA scales
...
ggplot(lsoa.join[lsoa.join$MSOA11CD %in% sample.20,], aes(x = lr_income, y = md_2015)) + geom_point() +
