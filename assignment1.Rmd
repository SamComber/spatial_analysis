...
<!-- SHOW 4 FIGURES OF DIFF SCALE REGIONS -->
...
\begin{table}[!htbp]
\begin{center}
\caption{Scaling problem tabulated.} \label{tab:scale}
...
<!-- SHOW 4 DIFFERENT ITERATIONS OF REGIONS USING FIGURES -->
...
A tabulation illustrating the zoning problem is shown in 

\begin{table}[!htbp]
\begin{center}
\caption{Zoning problem tabulated.} \label{tab:zone}
\begin{tabular}{@{} *5l @{}}    \toprule
\emph{name} & \emph{foo} &&&  \\\midrule
Models    & A  & B  & C  & D  \\ 
 Model $X$ & X1 & X2 & X3 & X4\\ 
