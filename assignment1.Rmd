...
Finally, we compute \autoref{fig:fan} to illustrate the 'fanning out' of prediction lines. Mostly, MSOAs are shown to have a negative slope which supports the theoretical expectation between income deprivation and median housing values. The positive covariance between the intercept and slopes implies that MSOAs with a large negative intercept tend to have a steep slope (stronger negative relationship between income deprivation and median housing values).
